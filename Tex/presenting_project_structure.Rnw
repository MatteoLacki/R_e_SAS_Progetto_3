...
To clarify plotting changes we have done within the new project the next table is as follows. 
...
Type of analysis                          & Old project plotting     & New project plotting \\
  \hline
  Analysis of satisfaction by life        & dotplot                  & qplot   \\ 
  Analysis of salaries by gender          & densityplot              & densityplot and qplot\\ 
  Analysis of Time and Distance to office & xyplot                   & \\ 
...
%  Satisfaction                            &                          &         \\ 
 \hline
\end{tabular}
 \caption{Comparing two project plotting systems}\label{data_description}
\end{table}
