...
@
  ...
  \begin{figure}[h]
    ...
    \subfloat[Before changes.]{
      \includegraphics[keepaspectratio=true,width=.4\linewidth]{Picts/satisfaction-Old_satisfaction.pdf} 
    }
    \subfloat[After changes.]{
      \includegraphics[keepaspectratio=true,width=.4\linewidth]{Picts/satisfaction-New_satisfaction.pdf} 
    }          
    \end{center}
